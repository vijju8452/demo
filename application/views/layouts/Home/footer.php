<footer id="footer" class="background-color-white">
        ...
        <script src="<?php echo $home_theme; ?>js/jquery.min.js"></script>
        <script src="<?php echo $home_theme; ?>js/bootstrap.min.js"></script>
        <script src="<?php echo $home_theme; ?>owlcarousel/owl.carousel.min.js"></script>

        <script src="<?php echo $home_theme; ?>js/jquery-ui.min.js"></script>
        <script src="<?php echo $home_theme; ?>js/custom.js"></script>
    </body>
